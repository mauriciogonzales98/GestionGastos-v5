...
|---|---|---|---|
| D9-01 | **SALDADA por la feature 011.** **La barra de filtros de categoría y de rango de fechas, y la interfaz de eliminación de un movimiento** | Es la mitad de frontend de FEAT-001b, que salió como feature de backend. La edición sí entra acá porque `PRD:FR-07` la necesita; los filtros de categoría y fecha y el borrado no los pide ningún requisito de este ticket, y arrastrarlos lo duplicaría | Ticket 6 (Maquetación y accesibilidad) |
...
| D9-05 | **SALDADA por la feature 011.** **El formato regional del monto según la moneda** y la columna `decimales`, que sigue sin usarse | Es maquetación. Es **D8-05** de la 008, que sigue apuntando al mismo lugar | Ticket 6 (Maquetación y accesibilidad) |
